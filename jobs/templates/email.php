...
A new job posting is available at https://www.anglican.ca/jobs :

Position Title: <?= $job->jobTitle . "\n" ?>
Postion type: <?= $job->type . "\n" ?>
View Job on-line at: https://<?= $_SERVER['SERVER_NAME'] . dirname($_SERVER['PHP_SELF']) ?>/index.php?action=JobPosting&id=<?= $job->id . "\n" ?>
